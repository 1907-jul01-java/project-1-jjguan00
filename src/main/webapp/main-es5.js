...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.create = function () {
        var _this = this;
        this.userservice.create(this.user).subscribe(function () { return _this.router.navigate(['/']); });
    };
